...
export function TaxIdsSection() {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Your UTR and National Insurance number are stored securely. You can choose a subscription plan next.
            </p>
            <Link
              href="/pricing"
  ...
  return (
    <section className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-8">
      <h3 className="text-lg font-bold text-slate-900">Step 1 — Add your UTR and NI number</h3>
      <p className="mt-2 text-sm text-slate-600">
        Your Unique Taxpayer Reference (UTR) and National Insurance number are required before you can choose a plan.
        They are encrypted and only used for your MTD submissions.
      </p>
